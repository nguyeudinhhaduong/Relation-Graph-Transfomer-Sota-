...
if platform.system().lower() == "windows":
    ...
    init_file = os.path.join(tempfile.gettempdir(), "relgt_ddp_init")
...
data, col_stats_dict = make_pkey_fkey_graph(
    ...
    text_embedder_cfg=TextEmbedderConfig(
        text_embedder=GloveTextEmbedding(device=(f"cuda:{local_rank}" if device.type == "cuda" else "cpu")), batch_size=256
    ),
